...
public class Compartir2 extends Activity {

    private static final String TAG = Compartir2.class.getName() ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_compartir2);
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_compartir2, menu);
